...
def test_env_aliases_map_to_settings(monkeypatch):
    ...
    monkeypatch.setenv("EVALUATION_BUCKET_NAME", "nxt-acad-hackathon-hackathon-evaluations")
    ...
    assert settings.gcs_bucket == "nxt-acad-hackathon-hackathon-evaluations"
...
def test_legacy_gcp_aliases_still_work(monkeypatch):
    ...
    assert settings.gcs_bucket == "legacy-bucket"
