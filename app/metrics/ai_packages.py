...
AI_PACKAGES: dict[str, str] = {
    ...
    "vertexai": "llm_sdk",
    "google-cloud-aiplatform": "llm_sdk",
    "@google/generative-ai": "llm_sdk",
    "@google/genai": "llm_sdk",
    "cohere": "llm_sdk",
    "mistralai": "llm_sdk",
    "groq": "llm_sdk",
    ...
    "llamaindex": "agent_framework",
    "@llamaindex/core": "agent_framework",
    "langchain-google-genai": "agent_framework",
    "langchain-google-vertexai": "agent_framework",
    "langchain-groq": "agent_framework",
    "langchain-mistralai": "agent_framework",
    "langchain-ollama": "agent_framework",
